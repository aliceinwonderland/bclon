...
\centering
\includegraphics[keepaspectratio,width=7cm]{theimg/bp}
...
\begin{center}
\fbox{
\subfigure[Enigma]{\includegraphics[width=5.5cm,keepaspectratio]{theimg/enigma}}  
\hspace{1cm}
\subfigure[Colossus]{\includegraphics[keepaspectratio,height=5.9cm]{theimg/colossus}} 
}
...
\centering
\fbox{
\includegraphics[keepaspectratio,width=7cm]{theimg/menace}
}
